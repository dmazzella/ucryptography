...
if __name__ == "__main__":
    ...
    nonce = RFC6979(msg, x, q, hashes.SHA1).gen_nonce()
    print(nonce == expected)

    expected = 0x23AF4074C90A02B3FE61D286D5C87F425E6BDD81B
    nonce = RFC6979(msg, x, q, hashes.SHA256).gen_nonce()
    print(nonce == expected)

    expected = 0x2132ABE0ED518487D3E4FA7FD24F8BED1F29CCFCE
    nonce = RFC6979(msg, x, q, hashes.SHA384).gen_nonce()
    print(nonce == expected)

    expected = 0x00BBCC2F39939388FDFE841892537EC7B1FF33AA3
    nonce = RFC6979(msg, x, q, hashes.SHA512).gen_nonce()
    print(nonce == expected)
