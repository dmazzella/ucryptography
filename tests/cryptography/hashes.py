...
def main():
    ...
    expected_blake2s = b'\xb7\xdf\x00<\xaap\xf14\x1c\xf6\xe0\x86\\\xeb\x9fD0\x08\xa1tZ#($kX\x90\x0c\xa6\xbc\xeb8'
    ...
    digest = hashes.Hash(hashes.SHA384(), default_backend())
    digest.update(b"caccone" * 1000)
    ...
    digest.update(b"caccone" * 1000)
    print(expected_blake2s == digest.finalize())
